...
public class Calc extends Application {
    ...
    private VBox createLayout(TextField screen, TilePane buttons) {
        ...
        // Create buttons to change background color
    Button redButton = new Button("Red");
    redButton.setStyle("-fx-font-size: 14px;-fx-cursor:hand");
    redButton.setOnAction(event -> layout.setStyle("-fx-background-color: red; -fx-padding: 20; -fx-font-size: 20;"));

    Button greenButton = new Button("Pink");
    greenButton.setStyle("-fx-font-size: 14px;-fx-cursor:hand");
    greenButton.setOnAction(event -> layout.setStyle("-fx-background-color: pink; -fx-padding: 20; -fx-font-size: 20;"));

    Button blueButton = new Button("Blue");
    blueButton.setStyle("-fx-font-size: 14px;-fx-cursor:hand");
    blueButton.setOnAction(event -> layout.setStyle("-fx-background-color: blue; -fx-padding: 20; -fx-font-size: 20;"));

    // Add buttons to layout
    HBox colorButtons = new HBox(10, redButton, greenButton, blueButton);
    colorButtons.setAlignment(Pos.CENTER);
    layout.getChildren().add(colorButtons);
    ...
    private TextField createScreen() {
        ...
        screen.setStyle("-fx-background-color: beige;-fx-font-weight:bold;-fx-font-family: Arial; -fx-font-size: 20;");
    ...
    private void makeOperandButton(Button button, final ObjectProperty<Op> triggerOp) {
        button.setStyle("-fx-base: yellow;-fx-cursor:hand");
        button.setOnAction(actionEvent -> curOp = triggerOp.get());
    }

    private Button makeStandardButton(String s) {
        Button button = new Button(s);
        button.setStyle("-fx-base: beige;-fx-cursor:hand");
    ...
    private void makeClearButton(Button button) {
        button.setStyle("-fx-base: green;-fx-cursor:hand");
